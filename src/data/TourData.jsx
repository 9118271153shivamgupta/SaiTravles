...
export const tourData = [
  ...
  },
  {
    ...
    itinerary: [
      ...
      { title: "Swayambhunath Monkey Dome & Kathmandu Durbar Plaza", desc: "Climb the stone stairs to Swayambhunath hill overlooking Kathmandu valley. Afternoon explore Kathmandu Durbar Square wood carvings and seek blessings near Living Goddess Kumari temple." },
      { title: "Patan Heritage Core Walk & Final Airport Departure", desc: "Visit Patan Durbar Square to witness exceptional medieval stone palaces and metal castings. Complete check out compliance and drop transit to airport for returning flights." }
    ],
    popularPlaces: [
  ...
  },
  {
    ...
    itinerary: [
      { title: "Kathmandu Airport Reception & Luxury Transfer", desc: "Arrive at Tribhuvan international gateway. Allocation of private luxury transit coaches to the city center. Free relaxation evening along Thamel premium tourist streets." },
      { title: "Pashupatinath & Boudhanath Comprehensive Spiritual Tour", desc: "Perform detailed morning prayers inside Pashupatinath Temple grounds. Post lunch, visit Boudhanath Stupa to explore rooftop monasteries and arts schools." },
      { title: "Kathmandu to Pokhara Scenic Highway Journey", desc: "Proceed on a breathtaking 6-hour mountain highway drive to Pokhara valley. Enjoy views of rushing Trisuli river streams and cascade mountain waterfalls mid-journey." },
      { title: "Pokhara Sarangkot Peak Dawn & Fewa Lake Boat Ride", desc: "Catch the sunrise splashing gold across Annapurna peak walls at Sarangkot. Return to valley for relaxing wooden boat rides up to Tal Barahi island shrine." },
      { title: "Davis Falls, Gupteshwor Cave & Pumdikot Shiva Giant", desc: "Explore rocky Davis Falls channels and subterranean cave setups. Drive higher up to see the colossal newly built Pumdikot Shiva Statue complex looking down over lake structures." },
      { title: "Pokhara to Kathmandu Return Flight & Evening Shopping", desc: "Board a short 25-minute domestic scenic mountain flight back to Kathmandu capital. Evening free to purchase Himalayan honey and singing bowls from local traditional bazaars." },
      { title: "Bhaktapur Durbar Square Tour & International Departure", desc: "Explore medieval wooden palace carvings at Bhaktapur Durbar Square zone. Complete travel clearances and check out for prompt transfers to international departure terminals." }
    ],
    popularPlaces: [
  ...
  },
  {
    ...
    itinerary: [
      { title: "Rishikesh to Guptkashi / Sonprayag Transit Corridor", desc: "Arrive at Rishikesh. Proceed on an 8-hour scenic highway transit along river Mandakini curves to reach Sonprayag base valley. Overnight stay inside comfortable riverside guest shelters." },
      { title: "The 16KM Arduous Spiritual Trek to Kedarnath Peak", desc: "Early 5:00 AM transit to Gaurikund. Start the challenging 16-kilometer mountain trek to Kedarnath shrine via foot/pony routes under high alpine air chanting continuous mantras." },
      { title: "Dawn Glacial Views, Main Temple Darshan & Descent", desc: "Attend early morning block darshans at the ancient stone interlocking Shiva shrine. Witness Bhairav Nath temple heights before trekking back down to Sonprayag base valley camps." },
      { title: "Sonprayag to Rishikesh Return & Laxman Jhula Checkout", desc: "Drive back to Rishikesh valley fields. Walk past historic suspension pedestrian iron bridges like Laxman Jhula and catch your return trains/buses back to home zones." }
    ],
    popularPlaces: [
