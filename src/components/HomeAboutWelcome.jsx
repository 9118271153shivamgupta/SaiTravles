  ...
  return (
    <section className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main Heading (Matched to Sky/Slate Deep Blue) */}
        <h2 className="text-3xl md:text-4xl font-black text-sky-950 tracking-tight mb-4 uppercase">
        ...
        <div className="border-t border-slate-100 pt-8">
          <h3 className="text-xl md:text-2xl font-black text-sky-900 mb-6 uppercase tracking-wide">
            Our Key Services
          </h3>
          ...
          <ul className="space-y-4 max-w-4xl">
            {services.map((service, index) => (
              <li key={index} className="flex items-start gap-3 group">
                ...
                <span className="text-slate-700 text-sm md:text-base font-extrabold leading-relaxed">
                  {service}
                </span>
              </li>
            ))}
        ...
        {/* Conditional "Read More" Button (Matched to Amber/Orange Theme) */}
        {showReadMore && (
          <div className="mt-10 pt-4">
            <button
              ...
              className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black px-6 py-3.5 rounded-xl shadow-md transition-all duration-300 hover:scale-105 active:scale-95 group cursor-pointer text-sm uppercase tracking-wider border border-amber-400"
            >
              Read More
